...
\documentclass[oneside,master]{snuthesis_euckr}
...
\advisor{Hong glidong}
\advisor*{Hong gildong} % Insert space for Hangul name.
...
\advisor{교수님 성함}
\advisor*{교수님 성함} % Insert space for Hangul name.
